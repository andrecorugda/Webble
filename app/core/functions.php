...
function appSecurity()
{
    if (!isset($_SESSION['logged_user'])) {
        header('Location: '.transRootConfig('app_config', 'app_login_index'));
    }
}
...
{
    if (isset($_SESSION['logged_user'])) {
        header('Location: '.transRootConfig('app_config', 'app_index'));
    }
}
 ...
 */
function dbQueryGetOne($query, $datatype = null, $params = null)
{
 ...
 * @param $params - Query parameters
 */
function dbQueryGet($query, $datatype = null, $params = null)
{
    $db_const = $this->transConfig('database_config');
 ...
 * @param $params - Query parameters
 */
function dbQueryExec($query, $datatype = null, $params = null)
{
    $db_const = $this->transConfig('database_config');
 ...
 */
function transConfig($trans_name, $trans_value = null)
{
    $config = new Config;
 ...
 * @param $trans_value - Array Key
 */
function transRootConfig($trans_name, $trans_value = null)
{
    $config = new Config;
 ...
 *
 */
function displayConfig($trans_name, $trans_value = null)
{
    $config = new Config;
 ...
 * @param $trans_value - Array Key
 */
function displayRootConfig($trans_name, $trans_value = null)
{
    $config = new Config;
    $root = $config->app_config['app_root'];
    if ($trans_value) {
 ...
 *
 */
function directTo($location, $extension = null)
{
    if ($extension) {
 ...
 */
function callView($view, $data = null)
{
...
/**{
    ...
    */
function callController($controller, $method = null, $requests = null)
{
...
function assets($file)
{
    ...
    return $link.''.transConfig('app_config', 'app_root').'/app/assets/'.$file;
}
 ...
 */
function sendEmail($mailto, $mailto_name, $subject = null, $body = null, $alt_body = null){
    ...
    try {
        //Server settings
        $mail->SMTPDebug = transConfig('mail_config','mail_smtp_debug');
        $mail->IsSMTP();
        $mail->SMTPAuth = transConfig('mail_config', 'mail_smtp_auth'); 
        $mail->SMTPSecure = transConfig('mail_config', 'mail_smtp_secure'); 
        $mail->Host = transConfig('mail_config', 'mail_host');
        $mail->Port = transConfig('mail_config', 'mail_port');
        $mail->Username = transConfig('mail_config', 'mail_username');
        $mail->Password = transConfig('mail_config', 'mail_password');

        $email_from = transConfig('mail_config', 'mail_name_from');
        $name_from = transConfig('mail_config', 'mail_from');
