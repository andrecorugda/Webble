...
class App
{
    ...
    {
        return [
            'app_root' => '/webble',//App root defines root directory if existing,
            'app_name' => 'Webble App',//App name is used to define app name
            'app_title' => 'Webble App | ',// App title is used to define application title on tabs
            'app_icon' => '',
            'app_404' => '/404',
            'app_405' => '/405',
            'app_index' => '/',//App index defines default uri directory
