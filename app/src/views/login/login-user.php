...
<head>
    ...
    <!-- Set Page Title -->
    <title>
        <?php displayConfig('app_config', 'app_title'); ?> Sign In User
    </title>
</head>
<body class="w-100 h-100"
      style="background: url('<?php echo assets('img/nice-bg.jpg') ?>');
            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                ...
                <div class="card card-signin my-5 text-white" style="background: none; box-shadow: none;">
                    <div class="card-body">
                        ...
                        <?php echo $data['error']; ?>
                        <!-- Form -->
                        <form method="POST" action="<?php displayRootConfig('app_config', 'app_login_user'); ?>">
                            <?php csrfToken(); ?>
                            <!-- Email -->
                            ...
                            <!-- Sign-up Button -->
                            <a href="<?php displayRootConfig('app_config', 'app_signup_user') ?>" class="btn btn-lg btn-primary mb-2 btn-block text-uppercase">Create an account</a>
                            <!-- Sign-user page link -->
                            <p id="emailHelp" class="form-text float-left">
                                <a href="<?php displayRootConfig('app_config', 'app_login_host') ?>" class="text-white">
